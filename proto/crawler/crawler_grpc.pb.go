...
type CrawlerMasterClient interface {
	AddResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*WorkerNodeSpec, error)
...
func (c *crawlerMasterClient) AddResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*WorkerNodeSpec, error) {
...
func (UnimplementedCrawlerMasterServer) AddResource(context.Context, *ResourceSpec) (*WorkerNodeSpec, error) {
